  ...
  if gameover_counter < 154 then
   ...
   if gameover_counter > 214 then
    if beat == blues_beat then
     ...
     if game_points > top_score_bebop then
      print_centered("top performance!",64,64,5)
      print_centered("top performance!",63,63,6)
     end
    end
   end
...

